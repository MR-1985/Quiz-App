...
function overlayTemp() {
    return `<div id="overlay-container" class="w-100 bg-secondary-subtle position-absolute start-0"
    style="top: 0vh; height: 100vh; z-index: 1001; align-content: center;">
    <div id="overlay" class="d-flex flex-column justify-content-center align-items-center">
        <img src="./imgs/quiz-9163786_640.jpg" alt="">
        <div class="progress">
            <div class="progress-bar progress-bar-striped bg-warning" id="progress-bar" role="progressbar"
                style="width: 15%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
